        ...
        <Grid className={classes.faq} item xs={12} lg={9}>
          <Accordion square expanded={expanded === 'faq-1'} onChange={handleChange('faq-1')}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>How do I use Swirge Launchpool?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                <img
                ...
                for in the vault. You will get a “receipt” called vToken in your wallet. Proceed
                to the related partner Launchpool vault here on the Swirge Launchpool site and enter
                the corresponding vault (or press the shortcut on the main vault page called Boost).
                The vault will ask for you to stake your vToken “receipts''. Stake these vTokens
          ...
          <Accordion square expanded={expanded === 'faq-2'} onChange={handleChange('faq-2')}>
            ...
            <AccordionDetails>
              <Typography>
                Enter the vault where you deposited your vTokens and it will show you a nice
          ...
          <Accordion square expanded={expanded === 'faq-4'} onChange={handleChange('faq-4')}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                deposited vTokens together with the partner tokens, at any time.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion square expanded={expanded === 'faq-5'} onChange={handleChange('faq-5')}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                vaults, one by one, and then deposit your vTokens (vault receipts) in the
          ...
          <Accordion square expanded={expanded === 'faq-6'} onChange={handleChange('faq-6')}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                your vTokens (vault receipts) in one of our partner vaults, the main boosted vault
                don’t see these receipts in your wallet, hence it shows you zero. As soon as you are
                finished with a partner vault, you withdraw your vTokens (receipts) back to your
          ...
          <Accordion square expanded={expanded === 'faq-7'} onChange={handleChange('faq-7')}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>What are vTokens?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                Once you stake in any of Swirge Finance vaults, you get in return something called
                vTokens. These are different depending on the vault you participate in, this can
                be called ‘vSWGb’ or ‘vAutoCake’. Basically these are receipts for the funds you
                deposited. They have no value, they’re just a way to show that you have a certain
                amount of tokens deposited in that vault. When you want to withdraw, your vTokens
          ...
          <Accordion square expanded={expanded === 'faq-8'} onChange={handleChange('faq-8')}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>
                If I enter a partner vault with my vTokens, will I still earn the ordinary vault
                reward?
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
          ...
          <Accordion square expanded={expanded === 'faq-9'} onChange={handleChange('faq-9')}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                rate” and is a fixed rate. Swirge shows APR by dividing the annual yield into 365
                days and presents that to you as “Daily”. APY on the other hand means “Annual
                percentage yield” which is when you take the daily yield and compound it. Swirge
          ...
          <Accordion square expanded={expanded === 'faq-11'} onChange={handleChange('faq-11')}>
            ...
            <AccordionDetails>
              <Typography>
                Yes! These partner vaults are hosted by Swirge and are completely safe. Swirge have
                gotten tokens from our partners and use our own vaults for the reward. Those
                vTokens you stake doesn’t leave Swirge.
              </Typography>
            </AccordionDetails>
          </Accordion>
        </Grid>
